jQuery(document).ready(function($){
     $(document).on('click' , '.upload-button', function(e) {
        ...
        var $this = $(this);
    	var image = wp.media({ 
    		title: wordify_wp_widgets_date.uploadimage,
    	...
    	.on('select', function(e){
            ...
            var img = "<img src='"+image_url+"' width='100px' /><a class='remove-image remove-screenshot'>"+wordify_wp_widgets_date.remove+"</a>";
